...
public class PorfolioDoubleConstrainedProblem extends AbstractDoubleProblem implements ConstrainedProblem<DoubleSolution> {
	...
	public PorfolioDoubleConstrainedProblem() throws JMetalException {
